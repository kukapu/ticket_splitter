defmodule TicketSplitter.Tickets do
  ...
  def get_effective_participants_count(ticket_id) do
    ...
    active_participants = get_ticket_participants(ticket_id)
  ...
  def calculate_participant_total_with_multiplier(ticket_id, participant_name) do
    ...
    |> Enum.reduce(Decimal.new("0"), fn product, acc ->
      ...
      common_cost =
        calculate_common_cost_with_multiplier(product, effective_participants, multiplier)
  ...
  defp calculate_common_cost_with_multiplier(product, effective_participants, multiplier) do
    # Legacy is_common support
    legacy_common =
      if product.is_common do

    ...
    <div id={@id}>
      ...
      <%= if @summary_tab == "summary" do %>
        <%= if @participant_name || @acting_as_participant do %>
          ...
          active_multiplier = if @acting_as_participant, do: @acting_as_multiplier, else: @my_multiplier %>
      ...
      <%= if @summary_tab == "assign" do %>
        <div class="space-y-4">
          ...
          <%= if @acting_as_participant do %>
            <div class="px-2 bg-warning/10 border border-warning/30 rounded-lg flex items-center justify-between">

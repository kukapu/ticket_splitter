defmodule TicketSplitterWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TicketSplitterWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TicketSplitterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TicketSplitterWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  the closing/cancel event, for example:
      ...
      <.modal id="confirm" on_cancel={JS.push("cancel")}>
        Are you sure?
      </.modal>
  """
  attr :id, :string, required: true
  ...
  attr :width, :string,
    default: "max-w-md",
    values: ~w(max-w-sm max-w-md max-w-lg max-w-xl max-w-2xl full)
  ...
  def modal(assigns) do
    ...
    >
      <div
        id={"#{@id}-bg"}
        class="bg-black/60 backdrop-blur-md fixed inset-0 transition-opacity"
        aria-hidden="true"
      />
      <div

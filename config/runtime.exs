...
#
#     PHX_SERVER=true bin/ticket_splitter start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ticket_splitter, TicketSplitterWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :ticket_splitter, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :ticket_splitter, TicketSplitter.Mailer,
